# -*- encoding: utf-8 -*-
# stub: chione 0.1.0.pre20150703132156 ruby lib

Gem::Specification.new do |s|
  s.name = "chione"
  s.version = "0.1.0.pre20150703132156"
  ...
  s.files = [".rdoc_options", ".simplecov", "ChangeLog", "History.md", "Manifest.txt", "README.md", "Rakefile", "lib/chione.rb", "lib/chione/aspect.rb", "lib/chione/assemblage.rb", "lib/chione/component.rb", "lib/chione/entity.rb", "lib/chione/manager.rb", "lib/chione/mixins.rb", "lib/chione/system.rb", "lib/chione/world.rb", "spec/chione/aspect_spec.rb", "spec/chione/assemblage_spec.rb", "spec/chione/component_spec.rb", "spec/chione/entity_spec.rb", "spec/chione/manager_spec.rb", "spec/chione/system_spec.rb", "spec/chione/world_spec.rb", "spec/chione_spec.rb", "spec/spec_helper.rb"]
